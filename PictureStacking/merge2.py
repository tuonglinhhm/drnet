...
edge = [[(-0.3, 1), (-0.3, 9.3)], [(10.3, 9.3), (-0.3, 9.3)], [(10.3, 9.3), (10.3, -0.3)], [(10.3, -0.3), (-0.3, -0.3)],
        [(-0.3, 0), (-0.3, -0.3)], [(0, 1), (-0.3, 1)], [(2, 2.3), (8, 2.3)], [(8, 2.3), (8, 1.3)],
        [(8, 1.3), (2, 1.3)], [(2, 1.3), (2, 2.3)], [(0.7, 6), (0.7, 9)], [(0, 6), (0.7, 6)], [(0, 6), (0, 1)],
        [(-0.3, 0), (9.3, 0)], [(9.3, 0), (9.3, 3)], [(9.3, 3), (10, 3)], [(10, 3), (10, 4)], [(10, 4), (2.5, 4)],
        [(2.5, 4), (2.5, 5)], [(2.5, 5), (10, 5)], [(10, 5), (10, 9)], [(10, 9), (9, 9)], [(9, 9), (9, 6)],
        [(9, 6), (8, 6)], [(8, 6), (8, 9)], [(8, 9), (6, 9)], [(6, 9), (6, 6)], [(6, 6), (5, 6)], [(5, 6), (5, 9)],
        [(5, 9), (3, 9)], [(3, 9), (3, 6)], [(3, 6), (2, 6)], [(2, 6), (2, 9)], [(2, 9), (0.7, 9)],
        [(-0.3, -0.3), (-2, -0.3)], [(-2, -0.3), (-2, 2)], [(-2, 2), (-0.3, 2)]]
edge = np.array(edge)

sprawn = [[-1, 0.5], [2.6, 0.7], [5.8, 2.7], [7.3, 0.7], [4.3, 3.7], [1.7, 6.7], [3.3, 6.7], [6.3, 8], [9.3, 6.7],
          [1, 5], [6.3, 6.7], [7.7, 6.7], [7.7, 8], [9.3, 8], [3.3, 8], [4.6, 8], [4.6, 6.7], [1.7, 8], [4, 0.7],
          [6, 0.7], [3.2, 3.7], [3.2, 2.7], [7.3, 2.7], [9, 3.5], [1, 1.5]]
...
def main(duration, T_time, counter, threshold,test_num):
        ...
        for y in range(0, 15):
            ...
            while not passed:
                if direction[y] == 1:
                    ...
                    passed = intersection_test(user_loc[y, 0], user_loc[y, 1],
                                               user_loc[y, 0] + 0.707 * speed / duration,
    ...
    save = "2/track" + str(test_num) + ".npy" # Changed
...
def MAIN():
    ...
    for i in range(lTt):
        for j in range(lthre):
            ...
            result = test(60, Tt[i], 15, thre[j], 25) # pos, neg, mix
