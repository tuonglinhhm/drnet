...
edge = [[(3, 0), (4, 0)], [(4.3, 3.3), (4.3, -0.3)], [(4.3, 3.3), (7.7, 3.3)], [(3, -0.3), (4.3, -0.3)],
        [(0.6, 0), (0.6, 6)], [(1, 0), (0.6, 0)], [(1, -0.3), (1, 0)], [(3, 0), (3, -0.3)], [(1, -0.3), (-3.8, -0.3)],
        [(4, 4), (4, 0)], [(-0.3, 6), (0.6, 6)], [(-1.1, 6), (-1.1, 5.8)], [(-1.1, 5.8), (-2.9, 5.8)],
        [(-2.9, 5.8), (-2.9, 5.1)], [(-3.5, 6), (-1.1, 6)], [(-3.5, 5.1), (-2.9, 5.1)], [(-3.5, 5.1), (-3.5, 2.5)],
        [(-1.1, 1.8), (-1.1, 1.5)], [(-1.1, 1.5), (-3.5, 1.5)], [(-3.5, 1.5), (-3.5, 0)], [(-0.3, 0.5), (-0.3, 6)],
        [(-1.5, 1.8), (-1.5, 2.5)], [(-1.5, 2.5), (-3.5, 2.5)], [(-1.5, 1.8), (-1.1, 1.8)], [(-0.3, 7), (0, 7)],
        [(-1.1, 7), (-1.1, 7.3)], [(-3.5, 7), (-3.5, 6)], [(-3.5, 7), (-1.1, 7)], [(-1.1, 7.3), (-2, 7.3)],
        [(-2, 7.3), (-2, 7.9)], [(-2, 7.9), (-3.5, 7.9)], [(-3.5, 7.9), (-3.5, 9)], [(-3.5, 9), (-2.8, 9)],
        [(-2.8, 9), (-2.8, 10.5)], [(-2.8, 10.5), (-0.3, 10.5)], [(-0.3, 10.5), (-0.3, 7)], [(0, 10.8), (0, 7)],
        [(-2.8, 10.8), (0, 10.8)], [(-2.8, 13.6), (-2.8, 10.8)], [(-0.3, 11.6), (0, 11.6)],
        [(-0.3, 11.6), (-0.3, 13.6)], [(-0.3, 13.6), (-2.8, 13.6)], [(4.3, 4), (4.3, 3.6)], [(4.3, 3.6), (6, 3.6)],
        [(4, 4), (4.3, 4)], [(6, 3.6), (6, 5.1)], [(6, 5.1), (6.6, 5.1)], [(6.6, 5.1), (6.6, 3.6)],
        [(6.6, 3.6), (7.4, 3.6)], [(7.4, 3.6), (7.4, 6.3)], [(7.4, 6.3), (4, 6.3)], [(4, 6.3), (4, 8)],
        [(4, 8), (4.3, 8)], [(4.3, 8), (4.3, 7.8)], [(4.3, 7.8), (4.8, 7.8)], [(4.8, 7.8), (4.8, 7.3)],
        [(4.8, 7.3), (7.4, 7.3)], [(7.4, 7.3), (7.4, 8.8)], [(7.4, 8.8), (4, 8.8)], [(4, 8.8), (4, 9.1)],
        [(2, 3.5), (2.7, 3.5)], [(2.7, 3.5), (2.7, 2)], [(2.7, 2), (2, 2)], [(2, 2), (2, 3.5)],
        [(-0.3, 0.5), (-0.8, 0.5)], [(-0.8, 0.5), (-0.8, 0)], [(-0.8, 0), (-3.5, 0)], [(4, 9.1), (6.7, 9.1)],
        [(6.7, 9.1), (6.7, 13.1)], [(6.7, 13.1), (2.5, 13.1)], [(4.5, 12.1), (5.5, 12.1)], [(5.5, 12.1), (5.5, 10.1)],
        [(5.5, 10.1), (4.5, 10.1)], [(4.5, 10.1), (4.5, 12.1)], [(0, 13.1), (0, 11.6)], [(0, 13.1), (1.7, 13.1)],
        [(1.7, 13.1), (1.7, 13.4)], [(1.7, 13.4), (0, 13.4)], [(0, 13.4), (0, 13.9)], [(0, 13.9), (-2.8, 13.9)],
        [(-2.8, 13.9), (-2.8, 14.4)], [(-2.8, 14.4), (-3.5, 14.4)], [(-3.5, 14.4), (-3.5, 16.1)],
        [(-3.5, 16.1), (-0.3, 16.1)], [(-0.3, 16.1), (-0.3, 14.7)], [(-0.3, 14.7), (0, 14.7)], [(0, 14.7), (0, 15.4)],
        [(0, 15.4), (6.7, 15.4)], [(6.7, 15.4), (6.7, 13.4)], [(6.7, 13.4), (2.5, 13.4)], [(2.5, 13.4), (2.5, 13.1)],
        [(7.7, 3.3), (7.7, 16.4)], [(7.7, 16.4), (-3.8, 16.4)], [(-3.8, 16.4), (-3.8, -0.3)],
        [(-3.8, -0.3), (-3.8, -6)], [(-3.8, -6), (7.7, -6)], [(7.7, -6), (7.7, 3.3)]]
trap = [[(-2.1, 13.6), (-2.1, 12.1)], [(-2.1, 12.1), (-0.3, 12.1)], [(-2.1, 10.5), (-2.1, 9)], [(-2.1, 9), (-0.3, 9)],
        [(-2.9, 5.1), (-1.7, 5.1)], [(-1.7, 5.1), (-1.7, 3.6)], [(-1.7, 3.6), (-3.5, 3.6)], [(3.3, 0), (3.3, 2)],
        [(3.3, 2), (3.3, 4)], [(3.3, 4), (4, 4)], [(3.3, 2), (4, 2)]]
edge = np.array(edge)
trap = np.array(trap)

sprawn = [[-2, 0.6], [-2, 15], [3, 14], [5.5, 15], [-2.5, 12.7], [-2.6, 5.4], [-2, 2.8], [-2.7, 8.4], [-2.5, 9.6],
          [2, -1], [3, 2.5], [3, 1], [7, 4.2], [5.5, 7.7], [4, 10.5], [4, 11.5], [6, 10.5], [6, 11.5], [2, 7.5],
          [5, 5.5], [2, 10], [3, -3], [2, 5], [6, 0], [2, 12.5]]
...
def avg(a):
    return np.round(sum(a) / len(a), 6)

def sigma(a):
    return np.round(math.sqrt(sum(x * x for x in a) / len(a) - avg(a) * avg(a)), 6) # square sum mean - avg square
def main(duration, T_time, counter, threshold,test_num):
    ...
    for x in range(1, T_time * duration):
        ...
        for y in range(0, user_count):
            ...
            while not passed:
                if direction[y] == 1:
                    passed = intersection_test(user_loc[y, 0], user_loc[y, 1], user_loc[y, 0] + speed / duration,
                                               user_loc[y, 1], y)
                    # print(passed)
                    if not passed:
                        direction[y] = random.randint(1, 8)
                    ...
                    passed = intersection_test(user_loc[y, 0], user_loc[y, 1], user_loc[y, 0] + 0.707 * speed / duration,
                                               user_loc[y, 1] + 0.707 * speed / duration, y)
                    # print(passed)
                    if not passed:
                        direction[y] = random.randint(1, 8)
                        # print(y,"	",direction[y])
                    ...
                    passed = intersection_test(user_loc[y, 0], user_loc[y, 1], user_loc[y, 0],
                                               user_loc[y, 1] + speed / duration, y)
                    # print(passed)
                    if not passed:
                        direction[y] = random.randint(1, 8)
                        # print(y,"	",direction[y])
    ...
    save = "3/track" + str(test_num) + ".npy" # Changed
    np.save(save, grid) # Changed
...
def test(duration, T_time, counter, threshold, tests_cnt):
    res = []
    for _ in range(tests_cnt):
        res.append([0.0,0.0,0.0])
    for i in range(tests_cnt):
        res[i] = main(duration, T_time, counter, 1.0,(i+1))
    for i in range(tests_cnt):
        res[i] = main(duration, T_time, counter, 1.3,(i+26))
    for i in range(tests_cnt):
        res[i] = main(duration, T_time, counter, 1.5,(i+51))
    for i in range(tests_cnt):
        res[i] = main(duration, T_time, counter, 2.0,(i+76))
    return res
...
def MAIN():
    ...
    lthre = len(thre)
    for i in range(lTt):
        for j in range(lthre):
            print("T_time : " + str(Tt[i]) + ", threshold : ", str(thre[j]), end="\n")  # Changed
            result = test(60, Tt[i], 10, thre[j], 25) # pos, neg, mix
            pos = [a[0] for a in result]
            neg = [a[1] for a in result]
            mix = [a[2] for a in result]
            # print("Accessible area accuracy: " + "average = " + str(avg(pos)) + ", standard deviation" + str(sigma(pos)))
            # print("Obstacle area accuracy: " + "average = " + str(avg(neg)) + ", standard deviation" + str(sigma(neg)))
            # print("Total accuracy: "  + "average = " + str(avg(mix)) + ", standard deviation" + str(sigma(mix)))
            d[(Tt[i],thre[j])] = ((avg(pos),sigma(pos)), (avg(neg), sigma(neg)), (avg(mix), sigma(mix)))

    for aa in d:
        print("T_time : " + str(aa[0]) + ", threshold : ", str(aa[1]), end="\n")
